...
import type { SelectProps, ValidationHandle } from '@/types/formTypes';

const Select = forwardRef<ValidationHandle, SelectProps>(({ id, label, name, required, value, options, onChange, onBlur, ...rest }, forwardedRef) => {
